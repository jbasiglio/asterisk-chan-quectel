...
INLINE_DECL const char *error2str(int err)
{
	static const char * const errors[] = {
		...
		"Invalid TPDU length in CMGR PDU status line", "Malformed hex string", "Invalid SCA", "Invalid TPDU type", "Cannot parse TPDU", "Invalid timestamp", "Invalid charset", "Cannot build SCA", "Cannot build phone number", "Input too large", "SMS functionality disabled"
	};
